  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.form}>
        ...
        <TouchableOpacity onPress={() => setShowFrom(true)} style={styles.input}><Text>{from.toLocaleDateString()}</Text></TouchableOpacity>
        {showFrom && (
          <DateTimePicker
            value={from}
            mode="date"
        ...
        <TouchableOpacity onPress={() => setShowTo(true)} style={styles.input}><Text>{to.toLocaleDateString()}</Text></TouchableOpacity>
        {showTo && (
          <DateTimePicker
            value={to}
            mode="date"
